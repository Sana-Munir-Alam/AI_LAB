...
dict['age'] = int(input("Enter Your Age:"))     # Display message and store user Value in dict by converting to int
...
if dict['age'] >= 18:                           # Note: Compare string with string, and int with int never mix these two. (we can convert input to int via int(input()))
